...
export const STARTERS: Starter[] = [
  ...
  },
  {
    ...
    record: {
      ...
      category: "Money",
      steps: [
        "GET https://api.nasdaq.com/api/quote/TSLA/info?assetclass=stocks",
        "GET https://api.nasdaq.com/api/quote/TSLA/summary?assetclass=stocks",
        "Answer with the current price, previous close, daily change, market status, and last trade time",
      ],
      outputs: [{ name: "price" }],
  ...
  },
  {
    ...
    record: {
      ...
      category: "Money",
      steps: [
        "GET https://api.nasdaq.com/api/quote/NVDA/info?assetclass=stocks",
        "GET https://api.nasdaq.com/api/quote/NVDA/summary?assetclass=stocks",
        "Answer with the current price, previous close, daily change, market status, and last trade time",
      ],
      outputs: [{ name: "price" }],
      sources: ["api.nasdaq.com"],
